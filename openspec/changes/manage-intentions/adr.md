...
- [ADR-0002](../../../docs/adr/0002-use-drift-sqlite-for-local-graph.md) — определяет основу постоянного хранения намерений: Drift/SQLite, транзакции, миграции и общую типизированную границу создания соединений.
...
- [ADR-0008](../../../docs/adr/0008-treat-sqlite-schema-functions-as-durable-contract.md) — важен для вычисляемого поискового ключа названия: его schema-function затрагивает настройку соединений, миграции, проверку схемы и trust boundary.
