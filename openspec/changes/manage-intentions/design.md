...
|  | auto-dispose UI state|             | operations + completions      |    |
|  +----------------------+             +--------+---------------+------+    |
|                                               | completion    | execute     |
|                                               v               v             |
|                              +----------------------+  +------------------+ |
