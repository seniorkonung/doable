...
**Summary:** Задача 5.22 подключила открытый редактор к подтверждённым снимкам исходной связи и сохранила черновик, но сведения о выбранном на замену намерении не обновляются; снимок связи также может вытеснить более свежий снимок каталога для того же ID. Оба дефекта требуют исправления. Принятых остаточных рисков нет.
...
### F1 · High — выбранный на замену участник остаётся со старым названием и состоянием

- **Evidence:** `lib/src/long_term_relation/presentation/editor/relation_editor_page.dart:52-69` подписывает форму только на `relationDetailsViewModelProvider` исходной связи. После выбора другого намерения `:256-270` сохраняет его снимок из каталога, а `lib/src/long_term_relation/presentation/editor/relation_editor_state.dart:424-437` обновляет роль лишь при совпадении выбранного ID с участником сохранённой связи. Пока правка не подтверждена, новое намерение отсутствует в подробном снимке этой связи. Добавленный тест `test/long_term_relation/presentation/editor/relation_editor_page_test.dart:765-803` после замены проверяет обновление лишь прежнего исходного участника.
- **Evidence revisions:** ["76c9f2ab0f52851af9b369caadad7373a06ad5cf"]
- **Impact:** Переименование или архивирование нового выбранного намерения до сохранения оставляет в открытой форме прежние название, архивное состояние и формулировку; пользователь видит недостоверный контекст команды.
- **Required outcome:** Подтверждённые изменения каждого текущего выбранного намерения доходят до открытой формы по его ID, включая выбор на замену, без потери черновика и основы правки.
