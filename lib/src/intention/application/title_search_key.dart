// Сгенерировано из Unicode CaseFolding-17.0.0.txt.
// Источник: https://www.unicode.org/Public/17.0.0/ucd/CaseFolding.txt
// SHA-256 источника: ff8d8fefbf123574205085d6714c36149eb946d717a0c585c27f0f4ef58c4183.
// Используются статусы C и F; S и Turkic-статус T намеренно исключены.

const unicodeDefaultCaseFoldingVersion = '17.0.0';

/// Строит поисковый ключ полным Unicode Default Case Folding.
String titleSearchKey(String value) => _UnicodeDefaultCaseFolding.fold(value);

abstract final class _UnicodeDefaultCaseFolding {
  static String fold(String value) {
    final buffer = StringBuffer();
    for (final codePoint in value.runes) {
      buffer.write(_mappings[codePoint] ?? String.fromCharCode(codePoint));
    }
    return buffer.toString();
  }

  static const Map<int, String> _mappings = <int, String>{
    0x0041: '\u{0061}',
    0x0042: '\u{0062}',
    0x0043: '\u{0063}',
    0x0044: '\u{0064}',
