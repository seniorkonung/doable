...
import 'package:doable/src/daily_choice/application/daily_choice_details.dart'
    as _i19;
import 'package:doable/src/daily_choice/domain/daily_choice_id.dart' as _i18;
...
import 'package:doable/src/daily_choice/presentation/source_picker/daily_choice_source_picker_page.dart'
    as _i6;
import 'package:doable/src/intention/domain/intention_id.dart' as _i16;
...
/// generated route for
/// [_i1.ChoicePathPage]
class ChoicePathRoute extends _i15.PageRouteInfo<ChoicePathRouteArgs> {
  ChoicePathRoute({
    required _i16.IntentionId sourceIntentionId,
    _i17.Key? key,
...
class ChoicePathRouteArgs {
  ...
  final _i16.IntentionId sourceIntentionId;
...
class DailyChoiceActionPickerRoute extends _i15.PageRouteInfo<void> {
  const DailyChoiceActionPickerRoute({List<_i15.PageRouteInfo>? children})
...
class DailyChoiceCatalogRoute extends _i15.PageRouteInfo<void> {
  const DailyChoiceCatalogRoute({List<_i15.PageRouteInfo>? children})
...
class DailyChoiceDetailsRoute
    extends _i15.PageRouteInfo<DailyChoiceDetailsRouteArgs> {
  DailyChoiceDetailsRoute({
    required _i18.DailyChoiceId choiceId,
    _i17.Key? key,
    List<_i15.PageRouteInfo>? children,
  }) : super(
...
class DailyChoiceDetailsRouteArgs {
  ...
  final _i18.DailyChoiceId choiceId;
...
class DailyChoiceEditRoute
    extends _i15.PageRouteInfo<DailyChoiceEditRouteArgs> {
  DailyChoiceEditRoute({
    required _i19.DailyChoiceDetails details,
    _i17.Key? key,
    List<_i15.PageRouteInfo>? children,
  }) : super(
...
class DailyChoiceEditRouteArgs {
  ...
  final _i19.DailyChoiceDetails details;
...
class DailyChoiceSourcePickerRoute extends _i15.PageRouteInfo<void> {
  const DailyChoiceSourcePickerRoute({List<_i15.PageRouteInfo>? children})
...
class IntentionCatalogRoute extends _i15.PageRouteInfo<void> {
  const IntentionCatalogRoute({List<_i15.PageRouteInfo>? children})
...
class IntentionDetailsRoute
    extends _i15.PageRouteInfo<IntentionDetailsRouteArgs> {
  IntentionDetailsRoute({
    required _i16.IntentionId intentionId,
    _i17.Key? key,
    List<_i15.PageRouteInfo>? children,
  }) : super(
...
class IntentionDetailsRouteArgs {
  ...
  final _i16.IntentionId intentionId;
...
class IntentionEditorRoute extends _i15.PageRouteInfo<void> {
  const IntentionEditorRoute({List<_i15.PageRouteInfo>? children})
...
class RelationDetailsRoute
    extends _i15.PageRouteInfo<RelationDetailsRouteArgs> {
  RelationDetailsRoute({
    required _i20.LongTermRelationId relationId,
    _i17.Key? key,
    List<_i15.PageRouteInfo>? children,
  }) : super(
...
class RelationDetailsRouteArgs {
  ...
  final _i20.LongTermRelationId relationId;
...
class RelationEditorRoute extends _i15.PageRouteInfo<RelationEditorRouteArgs> {
  RelationEditorRoute({
    required _i21.RelationEditorContext editorContext,
    _i17.Key? key,
    List<_i15.PageRouteInfo>? children,
  }) : super(
...
class RelationEditorRouteArgs {
  ...
  final _i21.RelationEditorContext editorContext;
...
class RelationParticipantPickerRoute
    extends _i15.PageRouteInfo<RelationParticipantPickerRouteArgs> {
  RelationParticipantPickerRoute({
    required _i16.IntentionId excludedIntentionId,
    required _i22.RelationParticipantSelectionContext selectionContext,
    _i17.Key? key,
    List<_i15.PageRouteInfo>? children,
  }) : super(
...
class RelationParticipantPickerRouteArgs {
  ...
  final _i16.IntentionId excludedIntentionId;

  final _i22.RelationParticipantSelectionContext selectionContext;
